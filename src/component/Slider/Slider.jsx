...
function Slider() {
  ...
  return (
    <>
      <div
        className="fullContainer hidden tablet:block h-[200vh] tablet:py-20 "
        useRef={container}
      >
        <div className=" h-[100vh] sticky top-0 w-full overflow-hidden py-10 gap-10 flex flex-col justify-evenly">
          <div className="tablet:h-[50vh] w-full overflow-hidden flex gap-5 items-center justify-center ">
            <div className="ImageWrapper ">
              <div className="laptop:w-[25rem] tablet:w-[20rem] h-full w-[200px]">
                <img
          ...
          <div className="tablet:h-[50vh] w-full overflow-hidden flex flex-row-reverse gap-5 items-center justify-center">
      ...
      {/* moobile */}
      <div className="flex flex-col w-full gap-5 py-5 items-center  overflow-x-hidden h-[500px]  tablet:hidden ">
        <div className=" w-full flex gap-2  -translate-x-24 ImageWrapper">
          <div className=" ">
            <div className="w-44">
              <img
                className="h-full w-full object-cover"
        ...
        <div className=" w-full flex gap-2  -translate-x-10 ImageWrapper">
          <div className=" ">
            <div className="w-28">
              <img
                className="h-full w-full object-cover"
